...
pars <- c("alpha", "beta_age", "beta_female", "gamma", "yrep")
...
mcmc_trace(samples, pars=c(paste0("alpha[", 1:length(unique(sgaj$patient)),"]")))
get_posterior_summary(sgaj_draws, c(paste0("alpha[", 1:length(unique(sgaj$patient)),"]")))
```
...
mcmc_trace(samples, pars=c(paste0("gamma[", 1:length(unique(sgaj$patient)),"]")))
get_posterior_summary(sgaj_draws, c(paste0("gamma[", 1:length(unique(sgaj$patient)),"]")))
```
